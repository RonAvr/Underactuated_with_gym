   ...
   <worldbody>
      ...
      <body name="base_link">
          ...
          <body name="Right motor">
              ...
              <joint name="joint_1" type="hinge" pos="0.045 0.0125 0.04" axis="0 1 0" limited="true" range="-45 45" stiffness="{motor_stiffness}" damping="{motor_damping}"/>
          </body>
          <body name="swivel_r" pos="0.05 0.025 0.0625" euler="0 0 30" >
              ...
              <body name="proximal_r" pos="0.0038 0 0.0475">
                  <joint name="swivel_proximal_r" type="hinge" axis="0 1 0" pos="0.006 0 -0.03" limited="true" range="-45 45" stiffness="{swivel_proximal_stiffness}" damping="{swivel_proximal_damping}"/>
                  ...
                  <body name="distal_r" pos="-0.027 0 0.068" euler="0 65 0">
                      <joint name="proximal_distal_r" type="hinge" axis="0 1 0" pos="0.041 0 0.0025" limited="true" range="-30 30" stiffness="{proximal_distal_stiffness}" damping="{proximal_distal_damping}"/>
          ...
          <body name="Left Motor">
              ...
              <joint name="joint_2" type="hinge" pos="0.045 -0.025 0.04" axis="0 1 0" limited="true" range="-45 45" stiffness="{motor_stiffness}" damping="{motor_damping}"/>
          </body>
          <body name="swivel_l" pos="0.05 -0.025 0.0625" euler="0 0 -30">
              <geom type="mesh" mesh="swivel_1"/>
              <body name="proximal_l" pos="0.0038 0 0.0475">
                  <joint name="swivel_proximal_l" type="hinge" axis="0 1 0" pos="0.006 0 -0.03" limited="true" range="-45 45" stiffness="{swivel_proximal_stiffness}" damping="{swivel_proximal_damping}"/>
                  <site name="s22" pos="0.007 0 -0.04" size="0.0015"/>
                  <geom name="22_cylinder" type="cylinder" size="0.005 0.01" pos="0.005 0 -0.029" rgba=".3 .9 .3 .4" euler="90 0 0"/>
                  <site name="s231" pos="0.0035 0 -0.035" size="0.0015"/>
                  <site name="s23" pos="0 0 -0.03" size="0.0015"/>
                  <geom name="23_cylinder" type="cylinder" size="0.004 0.01" pos="0.0014 0 -0.0175" rgba=".3 .9 .3 .4" euler="90 0 0"/>
                  ...
                  <geom name="24_cylinder" type="cylinder" size="0.004 0.01" pos="-0.00575 0 0.01675" rgba=".3 .9 .3 .4" euler="90 0 0"/>
                  <geom name="25_cylinder" type="cylinder" size="0.01 0.01" pos="-0.007 0 0.032" rgba=".3 .9 .3 .4" euler="90 0 0"/>
                  <geom name="proximal_l" type="mesh" mesh="proximal_O" pos="-0.01 -0.008 0.045" euler="90 180 -150"/>
                  <site name="s26" pos="-0.014 0 0.021" size="0.0015"/>
                  <body name="distal_l" pos="-0.027 0 0.068" euler="0 65 0">
                      <joint name="proximal_distal_l" type="hinge" axis="0 1 0" pos="0.041 0 0.0025" limited="true" range="-30 30" stiffness="{proximal_distal_stiffness}" damping="{proximal_distal_damping}"/>
                      <geom name="distal_l" type="mesh" mesh="distal_O" pos="-0.015 0.015 0.015" euler="-90 90 0"/>
          ...
          <body name="Center Motor">
              ...
              <joint name="joint_3" type="hinge" pos="-0.045 0 0.035" axis="0 1 0" limited="true" range="-45 45" stiffness="{motor_stiffness}" damping="{motor_damping}"/>
          </body>
          <body name="proximal_c" pos="-0.0138 0 0.1105">
              <joint name="swivel_proximal_c" type="hinge" axis="0 1 0" pos="-0.016 -0.01 -0.029" limited="true" range="-45 45" stiffness="{swivel_proximal_stiffness}" damping="{swivel_proximal_damping}"/>
              <geom name="35_cylinder" type="cylinder" size="0.01 0.01" pos="-0.003 0 0.032" rgba=".3 .9 .3 .4" euler="90 0 0"/>
              <geom name="proximal_c" type="mesh" mesh="proximal_O" pos="0 0.008 0.045" euler="90 0 -150"/>
              <site name="s32" pos="-0.016 0 -0.04" size="0.0015"/>
              <geom name="32_cylinder" type="cylinder" size="0.005 0.01" pos="-0.018 0 -0.029" rgba=".3 .9 .3 .4" euler="90 0 0"/>
              <site name="s331" pos="-0.0165 0 -0.035" size="0.0015"/>
              <site name="s33" pos="-0.023 0 -0.03" size="0.0015"/>
              <geom name="33_cylinder" type="cylinder" size="0.004 0.01" pos="-0.0115 0 -0.0175" rgba=".3 .9 .3 .4" euler="90 0 0"/>
              ...
              <geom name="34_cylinder" type="cylinder" size="0.004 0.01" pos="-0.0045 0 0.01675" rgba=".3 .9 .3 .4" euler="90 0 0"/>
              <site name="s36" pos="0.0025 0 0.021" size="0.0015"/>
              <body name="distal_c" pos="0.02 0 0.066" euler="0 120 0">
                  <joint name="proximal_distal_c" type="hinge" axis="0 1 0" pos="0.041 0 -0.0025" limited="true" range="-30 30" stiffness="{proximal_distal_stiffness}" damping="{proximal_distal_damping}"/>
                  <geom type="mesh" mesh="distal_O" pos="-0.015 -0.015 -0.015" euler="90 90 0"/>
