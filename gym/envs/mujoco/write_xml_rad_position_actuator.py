...
motor_lower_range = -0.2
motor_upper_range = 0.2
...
<mujoco>
   ...
   <actuator> <!-- Adding motors to the relevant joints -->
        <position joint="joint_1" name="swivel_proximal_r_motor" gear="0.1" ctrllimited="true" ctrlrange="{motor_lower_range} {motor_upper_range}"/>

        <position joint="joint_2" name="swivel_proximal_l_motor" gear="0.1" ctrllimited="true" ctrlrange="{motor_lower_range} {motor_upper_range}"/>

        <position joint="joint_3" name="swivel_proximal_c_motor" gear="0.1" ctrllimited="true" ctrlrange="{motor_lower_range} {motor_upper_range}"/>
    </actuator>
