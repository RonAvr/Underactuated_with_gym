...
#  These are the recorded trajectories of the real robot
...
def hyper_param_tune():
    ...
    def objective(params):
        ...
        # Update PID values in ros controller
        ...
        # Same actions that were applied on the real robot and produced the real trajectories
        # Now applied on the simulated robot
        for i in range(1, 50):
        ...
        total_error = error_5_b  # + error_3_u + error_2_l
    ...
    # Hyperparams space
    # You optimize each motor individually if they are not correlated. it is faster.
    space = {
